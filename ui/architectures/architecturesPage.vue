<template>
    <HoloPanes
    :pane-names="['architectures', 'archView']"
    :curr-pane="CurrPane">
        <template v-slot:architectures>
            <div class="relative">
                <h1>NET ARCHITECTURES</h1>
                <p>Your home away from meatspace.</p>
                <div @click="emit('reqest-modal', ModalType.NEW_ARCH)" class="add-new noselect green p-3 absolute top-3 right-0">
